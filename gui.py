...
scan_button = tk.Button(root, text="Start Scan", command=start_scan,
                        bg="#3c3f41", fg="white", activebackground="#5a5a5a")
scan_button.pack()
status = tk.Label(root, text="Status: Idle",
                  bg="#1e1e1e", fg="lightgreen")
status.pack()

clear_btn = tk.Button(root, text="Clear Output",
...
output.tag_config("open", foreground="#00ff00")   # Bright green
output.tag_config("vuln", foreground="#ff4d4d")  # Soft red
output.tag_config("info", foreground="#4da6ff")  # Light blue
